...
public class ProductionFactoryTest {
    ...
    public void testFactoryLoading_NormalCase() {
        ...
        assertTrue("工厂类映射应包含 ProductionFactory", factories.containsKey("production"));
        assertNotNull("加载的类应为 EnvironmentFactory 的子类", factories.get("production"));
    }
    ...
    public void testFactoryLoading_FileAsDirectory() {
        String directoryPath = "src/main/java/p2/EnvFactory/ProductionFactory.java";
        String suffix = "Factory";
        String packageName = "p2.EnvFactory";
